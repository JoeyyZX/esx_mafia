...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'themafia', Config.MaxInService)
end

TriggerEvent('esx_society:registerSociety', 'themafia', 'The Mafia', 'society_themafia', 'society_themafia', 'society_themafia', {type = 'whitelisted'})
...
AddEventHandler('esx_mafia:getStockItem', function(itemName, count)
	...
	local xPlayer = ESX.GetPlayerFromId(source)
	  ...
	  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_themafia', function(inventory)
...
ESX.RegisterServerCallback('esx_mafia:getArmoryWeapons', function(source, cb)
	...
	TriggerEvent('esx_datastore:getSharedDataStore', 'society_themafia', function(store)
...
ESX.RegisterServerCallback('esx_mafia:buy', function(source, cb, amount)
	...
	TriggerEvent('esx_addonaccount:getSharedAccount', 'society_themafia', function(account)
